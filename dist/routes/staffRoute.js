...
staffRouter.post("/admin/register", (0, registerValidator_1.registerValidator)(), validationHandler_1.validationHandler, staffController_1.default.createStaff);
staffRouter.get("/admin/staff", staffController_1.default.getStaff);
staffRouter.delete("/admin/staff/:id", staffController_1.default.deleteStaff);

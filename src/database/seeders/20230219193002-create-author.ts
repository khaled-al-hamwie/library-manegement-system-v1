    ...
    async up(queryInterface: QueryInterface, Sequelize: Sequelize) {
        await queryInterface.bulkInsert("Author", [
            ...
            },
            {
                ...
                description:
                    "Chingiz Aitmatov was a Russian-Kyrgyz writer and statesman known for such films as The First Teacher (1965), The Girl with the Red Scarf (1977) and Jamila (1994).\n\nHe was born Chingiz Torekulovich Aitmatov on December 12, 1928, in Kirgizia, Soviet Union. His family was bilingual, Russian-Kyrgyz. His ...",
            },
            {
                author_id: 58,
                name: "John Steinbeck",
            ...
            },
            {
                ...
                name: "Kazuo Ishiguro",
                description:
                    "Kazuo Ishiguro was born on November 8, 1954 in Nagasaki, Japan. He is a writer and producer, known for The Remains of the Day (1993), Never Let Me Go (2010) and Living (2022). He has been married to Lorna Anne MacDougall since 1986. They have one child.",
            },
            {
                author_id: 91,
                name: "Hermann Hesse",
